...
const UserProfileSettings = () => {
  const [formData, setFormData] = useState({
    username: 'User1', // Assuming current username is shown as 'Unchanged'
    email: 'user1@example.com', // Assuming current email is shown as 'unchanged@example.com'
    currentPassword: '',
    newPassword: '',
    confirmPassword: '',
    bio: 'Your current bio.', // Initial bio content
    avatar: null,
  });
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-semibold text-gray-900 mb-6"></h1>
